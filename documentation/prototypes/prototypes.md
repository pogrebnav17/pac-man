...
Prototype #5: Maze (borders and 4 exits) added to the game and rules set for it. Pac-man and ghost cannot cross walls, but will return on the same line on the opposite side if the leave the board through one of the gaps in the wall.
